...
_PROPERTYDESCRIPTION = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='constraints', full_name='PropertyDescription.constraints', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='subProperties', full_name='PropertyDescription.subProperties', index=3,
